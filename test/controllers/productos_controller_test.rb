...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { Costo: @producto.Costo, Nombre_Producto: @producto.Nombre_Producto, cod: @producto.cod, stock: @producto.stock }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { Costo: @producto.Costo, Nombre_Producto: @producto.Nombre_Producto, cod: @producto.cod, stock: @producto.stock }
    assert_redirected_to producto_path(assigns(:producto))
  end
